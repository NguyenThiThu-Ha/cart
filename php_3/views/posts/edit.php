...
<form method="post" >
  <table>
    ...
    <tr>
      ...
      <td><input class="desinput" type="text" name="description" value="<?php echo "$post->description"; ?>"></td>
    </tr>
    ...
    <tr style="background-color: #f2f2f2;">
      ...
      <td>
        ...
        <div class="imgpre">
          <img id="preview" style="width: 100px; height: 100px;" src="<?php echo "$post->image"; ?>">
        </div>
      </td>
    </tr>
